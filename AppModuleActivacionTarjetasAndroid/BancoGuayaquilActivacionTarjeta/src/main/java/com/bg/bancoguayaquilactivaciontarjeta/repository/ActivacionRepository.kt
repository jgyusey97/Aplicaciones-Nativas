...
import com.bg.bancoguayaquilactivaciontarjeta.api.ApiClient
...
class ActivacionRepository() {
    ...
    private val api = ApiClient.activacionApi
    ...
    */
    ...
    suspend fun getTarjetasPendientes(): List<TarjetaPendienteActivacion> {
        return api.getTarjetasPendientes("1306903160")
    }
